...
import 'package:amina/View_model/add_to_balance_view_model.dart';
...
class AddToBalanceView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final viewModel = Provider.of<AddToBalanceViewModel>(context);
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextWidget(text: 'المبلغ', color: Colors.black),
            ...
            Row(
              ...
              children: [
                TextWidget(text: "إضافة الرصيد من", color: Colors.black),
                Row(
                  children: [
                    TextButton(
                      onPressed: () {
                        showModalBottomSheet(
                          ...
                          builder: (context) => SelectMethodBottomSheet(
                            ...
                            message:
                                "إختر الوسيلة المناسبة لإضافة رصيد لمحفظتك",
                          ),
